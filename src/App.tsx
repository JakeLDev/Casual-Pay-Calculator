    ...
    <div className="App p-5 h-screen dark:bg-zinc-800 dark:text-gray-400">
      <div className="Container">
        ...
        <div className="flex flex-col items-center max-w-sm mx-auto my-2 text-inherit">
            ...
            <button className="bg-cyan-600 hover:bg-cyan-800 text-white font-bold my-2 py-2 px-4 rounded-full" id='CalendarToggle' onClick={toggleCalendar}>
        ...
        <ManualInterface manual={!calendar}/>
        <TotalPay />
